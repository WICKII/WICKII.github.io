本文档转载自[BY](https://github.com/qiubaiying/qiubaiying.github.io/)
> # BY Blog
...
2. 而这个模板是又是 [BY](http://qiubaiying.top/)从这里 [Hux](https://github.com/Huxpro/huxpro.github.io) fork 的, 同样感谢这个作者。 
